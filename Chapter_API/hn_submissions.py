...
import requests
#Wykonanie wyowałania API i zachowanie otrzymanej odpowiedzi
...
for submission_id in submission_ids[:10]:
	#Przygotowanie oddzoe;megp wywołania API dla każdego artykułu
...
for submission_dict in submission_dicts:
		print(f"Tytuł arttykułu: {submission_dict['title']}")
