import requests
#Wykonanie wywoałania API i zachowanie otrzymanej odpowiedzi
...
print(f"Całkowita liczba repozytorów {response_dict['total_count']}")
...
print("\n Wybrane informacje na temat repozytorium")
