...
class AlienInvasion:
	...
	def _update_bullets(self):
		#Uaktualnienie pocisków i usunięcie tych utworzonych na ekranie
		#Uaktualnienie
		self.bullets.update()
		#Usunięcie pocisków które znajduja sie poza ekranem
	...
	def _update_aliens(self):
		#Uaktualnienie polozenia wszytskich obcych we flocie
	...
	def _change_fleet_direction():
		#Przesuniecie calej floty w dół i zmiana kierunku w jakim się ona porusza
		for alien in self.aliens.sprites():
